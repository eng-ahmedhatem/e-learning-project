...
function Contact() {
  return (
    <div className=" container flex flex-col justify-center items-center min-h-screen mx-auto p-4">
      ...
      <div className="flex flex-col lg:flex-row w-full max-w-4xl gap-8">
        <form action="" className='w-full lg:w-1/2 p-5 flex flex-col'>
        ...
        <div className="map w-full lg:w-1/2  rounded-xl overflow-hidden p-5">
